...
public class test : MonoBehaviour {
	...
	void Start(){
		...
		// Texture2D tex = (Texture2D) Resources.Load("Resources/LiquidPhysics/DynamicParticle");
 ...
 void Update () {
	// V2int c = World2Pixel(pz.x, pz.y);
	
	// int r = Mathf.RoundToInt(pz.x*widthPixel/widthWorld);
